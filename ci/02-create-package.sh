...
#
#  Copyright (C) 2019, 2022, 2024  Dirk Stolle
#
...
wget -O glfwinfo_${VERSION}.orig.tar.bz2 https://gitlab.com/striezel/glfwinfo/-/archive/${COMMIT_HASH}/glfwinfo-${COMMIT_HASH}.tar.bz2
tar -x --bzip2 -f glfwinfo_${VERSION}.orig.tar.bz2
if [[ $? -ne 0 ]]
then
...
mv glfwinfo-${COMMIT_HASH} glfwinfo-${VERSION}
if [[ $? -ne 0 ]]
then
...
mv glfwinfo*.deb glfwinfo_${VERSION}-${RELEASE}_${ARCH}.deb
